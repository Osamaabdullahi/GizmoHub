        ...
        <div className="container mx-auto">
          ...
          <section className="mb-16">
            ...
            <p className="leading-relaxed mb-4">
              ...
              electronics. We're dedicated to providing you with the very best
              in consumer electronics, with a focus on quality, customer
            ...
            <p className="leading-relaxed">
              ...
              business. We now serve customers all over the world and are
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gray-100 p-6 rounded-lg shadow">
                <p className="leading-relaxed mb-4">
                  ...
                  impressed with the quality and quick shipping. Highly
                  recommend this site!"
                </p>

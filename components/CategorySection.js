    ...
    <div className="bg-gray-100 py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {/* Category Cards */}
          <div className="bg-white rounded-lg shadow-md p-4 flex items-center justify-center text-center hover:shadow-lg transition duration-300 ease-in-out">
            <a
              href="/category/mobile-phones"
              className="flex flex-col items-center text-black text-opacity-70 hover:text-opacity-100"
            >
